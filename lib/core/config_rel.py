...
# Memory Module
__C.MODEL.MEMORY_MODULE_FUSION = False
__C.MODEL.MEMORY_MODULE_SBJ_OBJ = False
__C.MODEL.MEMORY_MODULE_PRD = False
__C.MODEL.MEMORY_MSG_PASSING = False
__C.MODEL.COSNORM = False
__C.MODEL.ATTENTION = False
__C.MODEL.ATTENTION_DEEP = False
__C.MODEL.REACHABILITY = False
